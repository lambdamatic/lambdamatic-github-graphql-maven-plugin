...
public class OfType {
     ...
     * @param kind the kind
     * @param name the name
     * @param ofType the type (for generics)
     */
    public OfType(String kind, String name, Object ofType) {
        this.kind = kind;
        this.name = name;
        this.ofType = ofType;
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(kind).append(name)
                .append(ofType).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OfType) == false) {
            return false;
        }
        OfType rhs = ((OfType) other);
