...
public class FieldType {
    ...
    /**
     * Constructor.
     * @param kind the kind of field type
     * @param name the name of the field type
     * @param ofType the type of the field type (for generic types)
     */
    public FieldType(String kind, String name, Object ofType) {
        this.kind = kind;
        this.name = name;
        this.ofType = ofType;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FieldType) == false) {
            return false;
        }
        FieldType rhs = ((FieldType) other);
